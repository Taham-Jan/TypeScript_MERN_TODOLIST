    ...
    return (<>
			<form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
				...
				<div className={TodolistStyle_module_css_1.default.DialogBoxContainer}>
					...
					<div className={TodolistStyle_module_css_1.default.flexrow}>
						<label className={TodolistStyle_module_css_1.default.label} htmlFor="Email">
						<md_1.MdEmail className={Icons_module_css_1.default.ico2}/>
							<label className={TodolistStyle_module_css_1.default.placeholder}>Email</label>
						</label>
						<input type="email" id="email" className={TodolistStyle_module_css_1.default.input} placeholder='Enter your email...' {...register("email", { required: "dyy bhai" })}/>
					</div>
					<div className={TodolistStyle_module_css_1.default.flexrow}>
					...
					<div className={Button_module_css_1.default.DialogButtons}>
						<button className={`${Button_module_css_1.default.DialogButton} ${Button_module_css_1.default.buttonDesign}`} type="submit" disabled={isSubmitting}>SIGN-UP</button>
...
//# sourceMappingURL=SignUpModal.jsx.map