...
const AddEditListDialogBox = ({ dialogClose, onListEdit, onListSaved, taskLogo, priorityLogo, dateTimeLogo }) => {
    const { register, handleSubmit, formState: { errors, isSubmitting } } = (0, react_hook_form_1.useForm)({
        defaultValues: {
            ...
            status: (onListEdit === null || onListEdit === void 0 ? void 0 : onListEdit.status) || false,
        }
    });
    function onSubmit(input) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (onListEdit) {
                    todoListResponse = yield ListApi.updateTodoList(onListEdit._id, input);
                }
                else {
                    todoListResponse = yield ListApi.createTodoList(input);
                }
			...
			<form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
				...
				<div className={TodolistStyle_module_css_1.default.DialogBoxContainer}>
					...
					<div className={TodolistStyle_module_css_1.default.flexrow}>
						...
						<select className={TodolistStyle_module_css_1.default.input} {...register("priority", { required: "NO PRIORITY SET" })}>
...
//# sourceMappingURL=AddEditListDialogBox.jsx.map